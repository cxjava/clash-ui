...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_arm64")
		URL="https://github.com/cxjava/clash-ui/releases/download/latest/clash-ui_Darwin_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"darwin_amd64")
		URL="https://github.com/cxjava/clash-ui/releases/download/latest/clash-ui_Darwin_x86_64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_arm64")
		URL="https://github.com/cxjava/clash-ui/releases/download/latest/clash-ui_Linux_arm64.tar.gz"
		FTYPE=".tar.gz"
		;;
	"linux_amd64")
		URL="https://github.com/cxjava/clash-ui/releases/download/latest/clash-ui_Linux_x86_64.tar.gz"
		FTYPE=".tar.gz"
		;;
	*) fail "No asset for platform ${OS}-${ARCH}";;
	...
	if [[ $FTYPE = ".gz" ]]; then
		...
		bash -c "$GET $URL" > "clash-ui_${OS}_${ARCH}" || fail "download failed"
	else
